class Q2s3bController < ApplicationController
	...
	def create
		...
		if @path4 == "/4a/q2s4#4a"
			redirect_to "#{pathfinder_q2_q2s1_q2s2_q2s3_q2s3b_index_path}#{@path4}" if @path4.present?
		elsif @path4 == "/4b/q2s4#4b"
			redirect_to "#{pathfinder_q2_q2s1_q2s2_q2s3_q2s3b_index_path}#{@path4}" if @path4.present?
		else
			redirect_to "#{pathfinder_q2_q2s1_q2s2_q2s3_q2s3b_index_path}" if not @path4.present?
		end
	end
end
